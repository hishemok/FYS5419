...
\PY{k}{def} \PY{n+nf}{pauli\PYZus{}matrices}\PY{p}{(}\PY{p}{)}\PY{p}{:}
    \PY{n}{X} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,} 
                  \PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{]}\PY{p}{]}\PY{p}{)}
    
    \PY{n}{Y} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,} \PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{n}{j}\PY{p}{]}\PY{p}{,} 
                  \PY{p}{[}\PY{l+m+mi}{1}\PY{n}{j}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{]}\PY{p}{]}\PY{p}{)}
    
    \PY{n}{Z} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{p}{[}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{]}\PY{p}{,} 
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k}{def} \PY{n+nf}{tensor\PYZus{}product}\PY{p}{(}\PY{o}{*}\PY{n}{args}\PY{p}{)}\PY{p}{:}
\PY{+w}{    }\PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}Compute the tensor product of multiple matrices.\PYZdq{}\PYZdq{}\PYZdq{}}
    \PY{n}{result} \PY{o}{=} \PY{n}{args}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
    \PY{k}{for} \PY{n}{mat} \PY{o+ow}{in} \PY{n}{args}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{:}\PY{p}{]}\PY{p}{:}
        \PY{n}{result} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{kron}\PY{p}{(}\PY{n}{result}\PY{p}{,} \PY{n}{mat}\PY{p}{)}
    \PY{k}{return} \PY{n}{result}   

\PY{k}{def} \PY{n+nf}{sigma\PYZus{}site}\PY{p}{(}\PY{n}{j}\PY{p}{,} \PY{n}{n}\PY{p}{,} \PY{n}{operator}\PY{p}{)}\PY{p}{:}
\PY{+w}{    }\PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}Return the operator for site j in a chain of n sites.\PYZdq{}\PYZdq{}\PYZdq{}}
    \PY{n}{ops} \PY{o}{=} \PY{p}{[}\PY{n}{I}\PY{p}{]} \PY{o}{*} \PY{n}{n}
    \PY{n}{ops}\PY{p}{[}\PY{n}{j}\PY{p}{]} \PY{o}{=} \PY{n}{operator}
    \PY{k}{return} \PY{n}{tensor\PYZus{}product}\PY{p}{(}\PY{o}{*}\PY{n}{ops}\PY{p}{)}


\PY{k}{def} \PY{n+nf}{creation\PYZus{}annihilation}\PY{p}{(}\PY{n}{j}\PY{p}{,}\PY{n}{n}\PY{p}{)}\PY{p}{:}


    \PY{n}{f\PYZus{}dag} \PY{o}{=} \PY{p}{(}\PY{n}{sigma\PYZus{}site}\PY{p}{(}\PY{n}{j}\PY{p}{,} \PY{n}{n}\PY{p}{,} \PY{n}{X}\PY{p}{)} \PY{o}{+} \PY{l+m+mi}{1}\PY{n}{j} \PY{o}{*} \PY{n}{sigma\PYZus{}site}\PY{p}{(}\PY{n}{j}\PY{p}{,} \PY{n}{n}\PY{p}{,} \PY{n}{Y}\PY{p}{)}\PY{p}{)} \PY{o}{*} \PY{l+m+mf}{0.5}
    \PY{n}{f} \PY{o}{=} \PY{p}{(}\PY{n}{sigma\PYZus{}site}\PY{p}{(}\PY{n}{j}\PY{p}{,} \PY{n}{n}\PY{p}{,} \PY{n}{X}\PY{p}{)} \PY{o}{\PYZhy{}} \PY{l+m+mi}{1}\PY{n}{j} \PY{o}{*} \PY{n}{sigma\PYZus{}site}\PY{p}{(}\PY{n}{j}\PY{p}{,} \PY{n}{n}\PY{p}{,} \PY{n}{Y}\PY{p}{)}\PY{p}{)} \PY{o}{*} \PY{l+m+mf}{0.5}

    \PY{n}{Zops} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{eye}\PY{p}{(}\PY{l+m+mi}{2}\PY{o}{*}\PY{o}{*}\PY{n}{n}\PY{p}{)} 
    \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,} \PY{n}{j}\PY{p}{)}\PY{p}{:}
        \PY{n}{Zops} \PY{o}{@}\PY{o}{=} \PY{n}{sigma\PYZus{}site}\PY{p}{(}\PY{n}{i}\PY{p}{,} \PY{n}{n}\PY{p}{,} \PY{o}{\PYZhy{}}\PY{n}{Z}\PY{p}{)}


    \PY{n}{create} \PY{o}{=} \PY{n}{Zops} \PY{o}{@} \PY{n}{f\PYZus{}dag} 
    \PY{n}{annihilate} \PY{o}{=} \PY{n}{Zops} \PY{o}{@} \PY{n}{f} 

    \PY{k}{return} \PY{n}{create}\PY{p}{,} \PY{n}{annihilate}


\PY{k}{def} \PY{n+nf}{majoranas}\PY{p}{(}\PY{n}{n}\PY{p}{)}\PY{p}{:}
    \PY{n}{gammas} \PY{o}{=} \PY{p}{[}\PY{p}{]}
    \PY{k}{for} \PY{n}{j} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{n}\PY{p}{)}\PY{p}{:}
        \PY{n}{a\PYZus{}dag}\PY{p}{,} \PY{n}{a} \PY{o}{=} \PY{n}{creation\PYZus{}annihilation}\PY{p}{(}\PY{n}{j}\PY{p}{,}\PY{n}{n}\PY{p}{)}

        \PY{n}{gamma1} \PY{o}{=} \PY{n}{a\PYZus{}dag} \PY{o}{+} \PY{n}{a}
        \PY{n}{gamma2} \PY{o}{=} \PY{l+m+mi}{1}\PY{n}{j} \PY{o}{*} \PY{p}{(}\PY{n}{a\PYZus{}dag} \PY{o}{\PYZhy{}} \PY{n}{a}\PY{p}{)}

        \PY{n}{gammas}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{gamma1}\PY{p}{)}
        \PY{n}{gammas}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{gamma2}\PY{p}{)}
    \PY{n}{gammas} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{array}\PY{p}{(}\PY{n}{gammas}\PY{p}{)}
    \PY{k}{return} \PY{n}{gammas}

\PY{k}{def} \PY{n+nf}{delta}\PY{p}{(}\PY{n}{i}\PY{p}{,}\PY{n}{j}\PY{p}{)}\PY{p}{:}
\PY{+w}{    }\PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}Kronecker delta function.\PYZdq{}\PYZdq{}\PYZdq{}}
...
\PY{k}{def} \PY{n+nf}{check\PYZus{}anti\PYZus{}commutation}\PY{p}{(}\PY{n}{gammas}\PY{p}{)}\PY{p}{:}
\PY{+w}{    }\PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}Check the anti\PYZhy{}commutation relations of Majorana operators.\PYZdq{}\PYZdq{}\PYZdq{}}
    \PY{c+c1}{\PYZsh{} n = len(gammas)\PYZsq{}}
    \PY{n}{n} \PY{o}{=} \PY{n+nb}{len}\PY{p}{(}\PY{n}{gammas}\PY{p}{)} 
    \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{n}\PY{p}{)}\PY{p}{:}
        \PY{k}{for} \PY{n}{j} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{n}\PY{p}{)}\PY{p}{:}
            \PY{n}{result} \PY{o}{=} \PY{n}{gammas}\PY{p}{[}\PY{n}{i}\PY{p}{]} \PY{o}{@} \PY{n}{gammas}\PY{p}{[}\PY{n}{j}\PY{p}{]} \PY{o}{+} \PY{n}{gammas}\PY{p}{[}\PY{n}{j}\PY{p}{]} \PY{o}{@} \PY{n}{gammas}\PY{p}{[}\PY{n}{i}\PY{p}{]}
            \PY{n}{expected} \PY{o}{=} \PY{l+m+mi}{2} \PY{o}{*} \PY{n}{delta}\PY{p}{(}\PY{n}{i}\PY{p}{,} \PY{n}{j}\PY{p}{)} \PY{o}{*} \PY{n}{np}\PY{o}{.}\PY{n}{eye}\PY{p}{(}\PY{l+m+mi}{2}\PY{o}{*}\PY{o}{*}\PY{p}{(}\PY{n}{n}\PY{o}{/}\PY{o}{/}\PY{l+m+mi}{2}\PY{p}{)}\PY{p}{)}
            \PY{k}{assert} \PY{n}{np}\PY{o}{.}\PY{n}{allclose}\PY{p}{(}\PY{n}{result}\PY{p}{,} \PY{n}{expected}\PY{p}{)}\PY{p}{,} \PY{l+s+sa}{f}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Anti\PYZhy{}commutation failed for }\PY{l+s+si}{\PYZob{}}\PY{n}{i}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{, }\PY{l+s+si}{\PYZob{}}\PY{n}{j}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{. Expected:}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+si}{\PYZob{}}\PY{n}{expected}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{,}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+s2}{got:}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+si}{\PYZob{}}\PY{n}{result}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}
    
\PY{n}{gammas} \PY{o}{=} \PY{n}{majoranas}\PY{p}{(}\PY{l+m+mi}{3}\PY{p}{)}
\PY{n}{check\PYZus{}anti\PYZus{}commutation}\PY{p}{(}\PY{n}{gammas}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\PY{n}{γ0}\PY{p}{,} \PY{n}{γ1}\PY{p}{,} \PY{n}{γ2}\PY{p}{,} \PY{n}{γ3} \PY{o}{=} \PY{n}{majoranas}\PY{p}{(}\PY{l+m+mi}{2}\PY{p}{)}
...
\PY{n}{T\PYZus{}total} \PY{o}{=} \PY{l+m+mi}{100}
...
\end{tcolorbox}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
/tmp/ipykernel\_94568/1270564510.py:52: NumbaPerformanceWarning: '@' is faster on
...
\end{tcolorbox}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
/tmp/ipykernel\_94568/1156144857.py:9: ComplexWarning: Casting complex values to
real discards the imaginary part
  Parities[i, 0] = (np.vdot(ψ[i], op1@ψ[i]))
/tmp/ipykernel\_94568/1156144857.py:10: ComplexWarning: Casting complex values to
real discards the imaginary part
  Parities[i, 1] = (np.vdot(ψ[i], op2@ψ[i]))
/tmp/ipykernel\_94568/1156144857.py:11: ComplexWarning: Casting complex values to
real discards the imaginary part
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{} from scipy.linalg import expm}
\PY{c+c1}{\PYZsh{} from numba import njit, objmode}
\PY{c+c1}{\PYZsh{}\PYZsh{} Non\PYZhy{}abelian berry phase kato method}

\PY{k}{def} \PY{n+nf}{orthonormalize}\PY{p}{(}\PY{n}{vs}\PY{p}{)}\PY{p}{:}
\PY{+w}{    }\PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}Orthonormalize columns of vs using QR decomposition.\PYZdq{}\PYZdq{}\PYZdq{}}
    \PY{n}{q}\PY{p}{,} \PY{n}{\PYZus{}} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{linalg}\PY{o}{.}\PY{n}{qr}\PY{p}{(}\PY{n}{vs}\PY{p}{)}
    \PY{k}{return} \PY{n}{q}
...
\PY{k}{def} \PY{n+nf}{berry\PYZus{}phase\PYZus{}kato}\PY{p}{(}\PY{n}{times}\PY{p}{,} \PY{n}{evecs}\PY{p}{)}\PY{p}{:}
    ...
    \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n}{n} \PY{o}{\PYZhy{}} \PY{l+m+mi}{1}\PY{p}{)}\PY{p}{:}
        \PY{c+c1}{\PYZsh{} Pull out the two eigenvectors at step i and i+1}
        \PY{n}{v1} \PY{o}{=} \PY{n}{evecs}\PY{p}{[}\PY{n}{i}\PY{p}{,} \PY{p}{:}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{]}
        \PY{n}{v2} \PY{o}{=} \PY{n}{evecs}\PY{p}{[}\PY{n}{i}\PY{p}{,} \PY{p}{:}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{]}
        \PY{n}{w1} \PY{o}{=} \PY{n}{evecs}\PY{p}{[}\PY{n}{i}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{,} \PY{p}{:}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{]}
        \PY{n}{w2} \PY{o}{=} \PY{n}{evecs}\PY{p}{[}\PY{n}{i}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{,} \PY{p}{:}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{]}

        \PY{c+c1}{\PYZsh{} Build orthonormal subspace basis}
        \PY{n}{V} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{column\PYZus{}stack}\PY{p}{(}\PY{p}{(}\PY{n}{v1}\PY{p}{,} \PY{n}{v2}\PY{p}{)}\PY{p}{)}
        \PY{n}{W} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{column\PYZus{}stack}\PY{p}{(}\PY{p}{(}\PY{n}{w1}\PY{p}{,} \PY{n}{w2}\PY{p}{)}\PY{p}{)}

        \PY{c+c1}{\PYZsh{} [Optional] Align gauge by maximizing overlap}
        \PY{c+c1}{\PYZsh{} Replace with actual QR or SVD if needed}

        \PY{n}{P} \PY{o}{=} \PY{n}{V} \PY{o}{@} \PY{n}{V}\PY{o}{.}\PY{n}{conj}\PY{p}{(}\PY{p}{)}\PY{o}{.}\PY{n}{T}
        \PY{n}{P\PYZus{}next} \PY{o}{=} \PY{n}{W} \PY{o}{@} \PY{n}{W}\PY{o}{.}\PY{n}{conj}\PY{p}{(}\PY{p}{)}\PY{o}{.}\PY{n}{T}

        \PY{n}{dPdt} \PY{o}{=} \PY{p}{(}\PY{n}{P\PYZus{}next} \PY{o}{\PYZhy{}} \PY{n}{P}\PY{p}{)} \PY{o}{/} \PY{n}{dt}
        \PY{n}{K} \PY{o}{=} \PY{n}{P} \PY{o}{@} \PY{n}{dPdt} \PY{o}{\PYZhy{}} \PY{n}{dPdt} \PY{o}{@} \PY{n}{P}
...
\PY{n}{dmin\PYZus{}factor} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{linspace}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mf}{0.5}\PY{p}{,} \PY{l+m+mi}{20}\PY{p}{)}
...
\PY{n}{plt}\PY{o}{.}\PY{n}{xlabel}\PY{p}{(}\PY{l+s+sa}{r}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZdl{}Δ\PYZus{}}\PY{l+s+s1}{\PYZob{}}\PY{l+s+s1}{\PYZbs{}}\PY{l+s+s1}{text}\PY{l+s+si}{\PYZob{}min\PYZcb{}}\PY{l+s+s1}{\PYZcb{}/Δ\PYZus{}}\PY{l+s+s1}{\PYZob{}}\PY{l+s+s1}{\PYZbs{}}\PY{l+s+s1}{text}\PY{l+s+si}{\PYZob{}max\PYZcb{}}\PY{l+s+s1}{\PYZcb{}\PYZdl{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\PY{n}{plt}\PY{o}{.}\PY{n}{ylabel}\PY{p}{(}\PY{l+s+sa}{r}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZdl{}T\PYZus{}}\PY{l+s+s1}{\PYZob{}}\PY{l+s+s1}{\PYZbs{}}\PY{l+s+s1}{text}\PY{l+s+si}{\PYZob{}total\PYZcb{}}\PY{l+s+s1}{\PYZcb{}\PYZdl{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+sa}{r}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Berry Phase Fidelity vs \PYZdl{}Δ\PYZus{}}\PY{l+s+s1}{\PYZob{}}\PY{l+s+s1}{\PYZbs{}}\PY{l+s+s1}{text}\PY{l+s+si}{\PYZob{}min\PYZcb{}}\PY{l+s+s1}{\PYZcb{}\PYZdl{} and \PYZdl{}T\PYZus{}}\PY{l+s+s1}{\PYZob{}}\PY{l+s+s1}{\PYZbs{}}\PY{l+s+s1}{text}\PY{l+s+si}{\PYZob{}total\PYZcb{}}\PY{l+s+s1}{\PYZcb{}\PYZdl{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\PY{n}{plt}\PY{o}{.}\PY{n}{tight\PYZus{}layout}\PY{p}{(}\PY{p}{)}
\PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
\PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
...
\end{tcolorbox}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
Optimal T\_total: 100.000, Optimal Δ\_min/Δ\_max: 0.000
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{c+c1}{\PYZsh{}Find the parameters where both fidelities are above 0.99}
\PY{n}{above\PYZus{}99} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{where}\PY{p}{(}\PY{p}{(}\PY{n}{Fidelity\PYZus{}targets} \PY{o}{\PYZgt{}} \PY{l+m+mf}{0.999}\PY{p}{)} \PY{o}{\PYZam{}} \PY{p}{(}\PY{n}{Fidelity\PYZus{}Berry\PYZus{}targets} \PY{o}{\PYZgt{}} \PY{l+m+mf}{0.999}\PY{p}{)}\PY{p}{)}
\PY{n}{optimal\PYZus{}Ts} \PY{o}{=} \PY{n}{T\PYZus{}vals}\PY{p}{[}\PY{n}{above\PYZus{}99}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{]}
\PY{n}{optimal\PYZus{}dmins} \PY{o}{=} \PY{n}{dmin\PYZus{}factor}\PY{p}{[}\PY{n}{above\PYZus{}99}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{]}
\PY{n+nb}{print}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Parameters where both fidelities are above 0.999:}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}

\PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{optimal\PYZus{}Ts}\PY{p}{)}\PY{p}{)}\PY{p}{:}
    \PY{n}{T} \PY{o}{=} \PY{n}{optimal\PYZus{}Ts}\PY{p}{[}\PY{n}{i}\PY{p}{]}
    \PY{n}{dmin} \PY{o}{=} \PY{n}{optimal\PYZus{}dmins}\PY{p}{[}\PY{n}{i}\PY{p}{]}
    \PY{n}{fid} \PY{o}{=} \PY{n}{Fidelity\PYZus{}targets}\PY{p}{[}\PY{n}{above\PYZus{}99}\PY{p}{]}\PY{p}{[}\PY{n}{i}\PY{p}{]}
    \PY{n}{berry\PYZus{}fid} \PY{o}{=} \PY{n}{Fidelity\PYZus{}Berry\PYZus{}targets}\PY{p}{[}\PY{n}{above\PYZus{}99}\PY{p}{]}\PY{p}{[}\PY{n}{i}\PY{p}{]}
    \PY{n+nb}{print}\PY{p}{(}\PY{l+s+sa}{f}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{T\PYZus{}total: }\PY{l+s+si}{\PYZob{}}\PY{n}{T}\PY{l+s+si}{:}\PY{l+s+s2}{.3f}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{, Δ\PYZus{}min/Δ\PYZus{}max: }\PY{l+s+si}{\PYZob{}}\PY{n}{dmin}\PY{l+s+si}{:}\PY{l+s+s2}{.3f}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{, Fidelity: }\PY{l+s+si}{\PYZob{}}\PY{n}{fid}\PY{l+s+si}{:}\PY{l+s+s2}{.4f}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{, Berry Phase Fidelity: }\PY{l+s+si}{\PYZob{}}\PY{n}{berry\PYZus{}fid}\PY{l+s+si}{:}\PY{l+s+s2}{.4f}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}

    \begin{Verbatim}[commandchars=\\\{\}]
Parameters where both fidelities are above 0.999:
T\_total: 100.000, Δ\_min/Δ\_max: 0.000, Fidelity: 1.0000, Berry Phase Fidelity:
1.0000
T\_total: 147.368, Δ\_min/Δ\_max: 0.026, Fidelity: 0.9992, Berry Phase Fidelity:
0.9991
T\_total: 147.368, Δ\_min/Δ\_max: 0.053, Fidelity: 1.0000, Berry Phase Fidelity:
0.9999
T\_total: 194.737, Δ\_min/Δ\_max: 0.026, Fidelity: 0.9993, Berry Phase Fidelity:
0.9994
T\_total: 194.737, Δ\_min/Δ\_max: 0.105, Fidelity: 0.9994, Berry Phase Fidelity:
0.9994
T\_total: 194.737, Δ\_min/Δ\_max: 0.368, Fidelity: 0.9994, Berry Phase Fidelity:
0.9994
T\_total: 336.842, Δ\_min/Δ\_max: 0.026, Fidelity: 1.0000, Berry Phase Fidelity:
1.0000
T\_total: 384.211, Δ\_min/Δ\_max: 0.026, Fidelity: 0.9997, Berry Phase Fidelity:
0.9997
T\_total: 384.211, Δ\_min/Δ\_max: 0.053, Fidelity: 0.9998, Berry Phase Fidelity:
0.9998
T\_total: 431.579, Δ\_min/Δ\_max: 0.026, Fidelity: 0.9991, Berry Phase Fidelity:
0.9991
T\_total: 431.579, Δ\_min/Δ\_max: 0.105, Fidelity: 1.0000, Berry Phase Fidelity:
1.0000
T\_total: 431.579, Δ\_min/Δ\_max: 0.132, Fidelity: 0.9995, Berry Phase Fidelity:
0.9995
T\_total: 431.579, Δ\_min/Δ\_max: 0.158, Fidelity: 0.9998, Berry Phase Fidelity:
0.9998
T\_total: 431.579, Δ\_min/Δ\_max: 0.447, Fidelity: 0.9997, Berry Phase Fidelity:
0.9997
T\_total: 478.947, Δ\_min/Δ\_max: 0.026, Fidelity: 0.9998, Berry Phase Fidelity:
0.9998
T\_total: 526.316, Δ\_min/Δ\_max: 0.026, Fidelity: 0.9996, Berry Phase Fidelity:
0.9996
T\_total: 526.316, Δ\_min/Δ\_max: 0.158, Fidelity: 0.9999, Berry Phase Fidelity:
0.9999
T\_total: 573.684, Δ\_min/Δ\_max: 0.026, Fidelity: 0.9994, Berry Phase Fidelity:
0.9994
T\_total: 621.053, Δ\_min/Δ\_max: 0.026, Fidelity: 0.9997, Berry Phase Fidelity:
0.9997
T\_total: 715.789, Δ\_min/Δ\_max: 0.026, Fidelity: 0.9995, Berry Phase Fidelity:
0.9995
T\_total: 715.789, Δ\_min/Δ\_max: 0.132, Fidelity: 1.0000, Berry Phase Fidelity:
1.0000
T\_total: 763.158, Δ\_min/Δ\_max: 0.053, Fidelity: 0.9995, Berry Phase Fidelity:
0.9995
T\_total: 810.526, Δ\_min/Δ\_max: 0.105, Fidelity: 0.9991, Berry Phase Fidelity:
0.9991
T\_total: 857.895, Δ\_min/Δ\_max: 0.105, Fidelity: 1.0000, Berry Phase Fidelity:
1.0000
T\_total: 857.895, Δ\_min/Δ\_max: 0.211, Fidelity: 0.9990, Berry Phase Fidelity:
0.9990
T\_total: 905.263, Δ\_min/Δ\_max: 0.026, Fidelity: 0.9999, Berry Phase Fidelity:
0.9999
T\_total: 905.263, Δ\_min/Δ\_max: 0.132, Fidelity: 0.9993, Berry Phase Fidelity:
0.9993
T\_total: 952.632, Δ\_min/Δ\_max: 0.026, Fidelity: 0.9997, Berry Phase Fidelity:
0.9997
T\_total: 952.632, Δ\_min/Δ\_max: 0.079, Fidelity: 0.9996, Berry Phase Fidelity:
0.9996
T\_total: 1000.000, Δ\_min/Δ\_max: 0.079, Fidelity: 0.9999, Berry Phase Fidelity:
0.9999
T\_total: 1000.000, Δ\_min/Δ\_max: 0.132, Fidelity: 0.9991, Berry Phase Fidelity:
0.9991
T\_total: 1000.000, Δ\_min/Δ\_max: 0.237, Fidelity: 0.9995, Berry Phase Fidelity:
0.9995
    \end{Verbatim}
...
\end{tcolorbox}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Braiding_project_files/Braiding_project_41_0.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\end{tcolorbox}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
/tmp/ipykernel\_94568/1466126454.py:9: ComplexWarning: Casting complex values to
real discards the imaginary part
  Parities[i, 0] = (np.vdot(ψ[i], op1@ψ[i]))
/tmp/ipykernel\_94568/1466126454.py:10: ComplexWarning: Casting complex values to
real discards the imaginary part
  Parities[i, 1] = (np.vdot(ψ[i], op2@ψ[i]))
/tmp/ipykernel\_94568/1466126454.py:11: ComplexWarning: Casting complex values to
real discards the imaginary part
  Parities[i, 2] = (np.vdot(ψ[i], op3@ψ[i]))
    \end{Verbatim}

    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Braiding_project_files/Braiding_project_42_1.png}
    \end{center}
    { \hspace*{\fill} \\}
